...
def construct():
  ...
  parameters = {
    ...
    'design_name'    : 'puf_super',
    'clock_period'   : 100.0,
    'adk'            : adk_name,
    'adk_view'       : adk_view,
    'topographical'  : True,
    'testbench_name' : 'puf_super_tb',
    'saif_instance'  : 'puf_super_tb/puf_super_inst',
    'dut_name'       : 'puf_super_inst'
  }
  ...
  gl_sim.extend_inputs(['test_vectors.txt','BR32.vcs.v','BR64.vcs.v','BR128.vcs.v','NBR32.vcs.v','NBR64.vcs.v','NBR128.vcs.v'])
  dc.extend_inputs(['analog.db'])
  iflow.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  init.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  power.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  place.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  cts.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  postcts_hold.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  route.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  postroute.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  signoff.extend_inputs(['analog.lib', 'BR32.lef','BR64.lef','BR128.lef','NBR32.lef','NBR64.lef','NBR128.lef']);
  gdsmerge.extend_inputs(['BR32.gds','BR64.gds','BR128.gds','NBR32.gds','NBR64.gds','NBR128.gds']);
  ...
  calibre_lvs.extend_inputs(['BR32.sp','BR64.sp','BR128.sp']); 
  ...
  g.connect( rtl.o( 'BR128.vcs.v'     ), gl_sim.i( 'BR128.vcs.v'     ) )
  g.connect( rtl.o( 'BR64.vcs.v'     ), gl_sim.i( 'BR64.vcs.v'     ) )
  g.connect( rtl.o( 'BR32.vcs.v'     ), gl_sim.i( 'BR32.vcs.v'     ) )
