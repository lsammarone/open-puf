...
# Take all ports and split into halves
 ...
 set quart_ports_idx  [expr $num_ports / 4]

 set pins_left  [lrange $all_ports 0               [expr $quart_ports_idx - 1]]
 set pins_top  [lrange $all_ports $quart_ports_idx               [expr [expr $quart_ports_idx*2] - 1]]
 set pins_right [lrange $all_ports [expr $quart_ports_idx*2] [expr [expr $quart_ports_idx*3] - 1]     ]
 set pins_bot [lrange $all_ports [expr $quart_ports_idx*3] [expr $num_ports -1]     ]
...
editPin -layer met2 -pin $pins_bot -side BOTTOM -spreadType SIDE
