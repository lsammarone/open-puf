...
N 270 110 290 110 { lab=VGND}
N 670 740 730 740 { lab=#net15}
N 810 740 880 740 { lab=#net16}
...
C {devices/vsource.sym} 1370 250 0 0 {name=V2 value=0.9}
C {devices/lab_pin.sym} 1370 310 0 0 {name=l21 sig_type=std_logic lab=VGND}
C {devices/vsource.sym} 410 840 0 0 {name=V4 value=PULSE"(0 1.8 0ns 10ps 10ps 1.25ns 5ns) DC=0.8"}
...
C {devices/ngspice_get_value.sym} 310 350 0 1 {name=r1 node="i(@m.xm6.msky130_fd_pr__nfet_01v8_lvt[id])"
descr="id="}
C {devices/ngspice_get_value.sym} 530 350 0 1 {name=r2 node="i(@m.xm5.msky130_fd_pr__nfet_01v8_lvt[id])"
descr="id="}
C {devices/ngspice_get_value.sym} 740 350 0 1 {name=r3 node="i(@m.xm3.msky130_fd_pr__nfet_01v8_lvt[id])"
descr="id="}
C {devices/ngspice_get_value.sym} 960 350 0 1 {name=r4 node="i(@m.xm11.msky130_fd_pr__nfet_01v8_lvt[id])"
descr="id="}
C {devices/ngspice_get_value.sym} 1220 340 0 1 {name=r5 node="i(@m.xm15.msky130_fd_pr__nfet_01v8_lvt[id])"
descr="id="}
C {devices/ngspice_get_value.sym} 1220 -90 0 1 {name=r6 node="i(@m.xm17.msky130_fd_pr__pfet_01v8_lvt[id])"
descr="id="}
C {devices/lab_pin.sym} 280 110 0 0 {name=l27 sig_type=std_logic lab=VGND}
C {sky130_fd_pr/res_high_po_1p41.sym} 310 110 0 0 {name=R2
W=1.41
L=12
model=res_high_po_1p41
spiceprefix=X
mult=1}
C {devices/noconn.sym} 1370 170 0 0 {name=l1}
C {sky130_stdcells/inv_2.sym} 630 740 0 0 {name=x1 VGND=VGND VNB=VGND VPB=VPWR VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_8.sym} 770 740 0 0 {name=x2 VGND=VGND VNB=VGND VPB=VPWR VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 530 740 0 0 {name=l23 sig_type=std_logic lab=VIN}
C {devices/noconn.sym} 870 740 0 0 {name=l28}
