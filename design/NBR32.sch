...
N -150 140 -120 140 { lab=int_out2[5:0],int_out2[31]}
N 50 140 90 140 { lab=int_out2[6:0]}
N 90 140 170 140 { lab=int_out2[6:0]}
N -30 160 10 160 { lab=buf_out[6:0]}
N 10 160 10 220 { lab=buf_out[6:0]}
N 450 150 480 150 { lab=int_out2[13:6]}
N 650 150 730 150 { lab=int_out2[14:7]}
N 730 150 770 150 { lab=int_out2[14:7]}
N 570 170 610 170 { lab=buf_out[14:7]}
N 610 170 610 220 { lab=buf_out[14:7]}
N 1050 170 1080 170 { lab=int_out2[22:14]}
N 1290 170 1370 170 { lab=int_out2[23:15]}
N 1250 170 1290 170 { lab=int_out2[23:15]}
N 1170 190 1210 190 { lab=buf_out[23:15]}
N 1210 190 1210 240 { lab=buf_out[23:15]}
N 1630 190 1660 190 { lab=int_out2[30:23]}
N 1870 190 1950 190 { lab=#net5}
N 1830 190 1870 190 { lab=#net5}
N 1750 210 1790 210 {}
N 1790 210 1790 260 {}
...
C {singlestage_nbr.sym} 30 100 0 0 {name=x41[6:0]}
...
C {singlestage_nbr.sym} 630 110 0 0 {name=x1[7:0]}
...
C {singlestage_nbr.sym} 1230 130 0 0 {name=x2[8:0]}
...
C {singlestage_nbr.sym} 1810 150 0 0 {name=x3[7:0]}
...
C {devices/lab_pin.sym} -140 140 0 0 {name=l8 sig_type=std_logic lab=int_out2[5:0],int_out2[31]
}
C {devices/lab_pin.sym} 170 140 0 0 {name=l9 sig_type=std_logic lab=int_out2[6:0]
}
C {devices/lab_pin.sym} 460 150 0 0 {name=l10 sig_type=std_logic lab=int_out2[13:6]
}
C {devices/lab_pin.sym} 770 150 0 0 {name=l11 sig_type=std_logic lab=int_out2[14:7]
}
C {devices/lab_pin.sym} 1060 170 0 0 {name=l12 sig_type=std_logic lab=int_out2[22:14]
}
C {devices/lab_pin.sym} 1370 170 0 0 {name=l13 sig_type=std_logic lab=int_out2[23:15]
}
C {devices/lab_pin.sym} 1640 190 0 0 {name=l14 sig_type=std_logic lab=int_out2[30:23]
}
C {devices/lab_pin.sym} 1950 190 0 0 {name=l15 sig_type=std_logic lab=int_out2[31:24]
}
