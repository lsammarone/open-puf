...
N 140 -30 190 -190 { lab=#net3}
N 190 -190 250 -190 { lab=#net3}
N 230 -150 250 -150 { lab=#net4}
N 140 80 210 -150 { lab=#net4}
N 210 -150 230 -150 { lab=#net4}
...
C {devices/opin.sym} 520 170 0 0 {name=p7 lab=buf_out}
