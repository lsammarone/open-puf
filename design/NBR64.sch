...
N -70 -90 -30 -90 { lab=r5,r4,r4,r4,r4,r4,r4,r4}
...
N -70 -130 -70 -90 { lab=r5,r4,r4,r4,r4,r4,r4,r4}
N 1390 190 1460 190 { lab=out2[0],out2[63:57]}
...
N 1460 190 1500 190 { lab=out2[0],out2[63:57]}
...
N 1500 190 1600 190 { lab=out2[0],out2[63:57]}
N 1340 270 1340 310 { lab=OUT,buf_out[6:0]}
N 1340 310 1460 310 { lab=OUT,buf_out[6:0]}
N 1220 -30 1220 30 { lab=out2[7:0]}
N 1220 30 1220 40 { lab=out2[7:0]}
N 1390 -30 1390 50 { lab=out2[8:1]}
N 1310 -10 1310 30 { lab=#net5}
N 800 -30 800 30 { lab=out2[15:8]}
N 970 -30 970 40 { lab=out2[16:9]}
N 800 30 800 40 { lab=out2[15:8]}
N 890 -10 890 50 { lab=#net6}
N 380 -30 380 50 { lab=out2[23:16]}
N 550 -30 550 60 { lab=out2[24:17]}
N 470 -10 470 50 { lab=#net7}
N -30 -30 -30 40 { lab=out2[31:24]}
N 140 -30 140 50 { lab=out2[32:25]}
N -30 40 -30 50 { lab=out2[31:24]}
N 60 -10 60 40 { lab=#net8}
N -30 230 -30 320 { lab=out2[39:32]}
N 140 230 140 330 { lab=out2[40:33]}
N 60 250 60 300 { lab=#net9}
N 380 230 380 330 { lab=out2[47:40]}
N 550 230 550 340 { lab=out2[48:41]}
N 470 250 470 310 { lab=#net10}
N 800 230 800 330 { lab=out2[55:48]}
N 970 230 970 340 { lab=out2[56:49]}
N 890 250 890 310 { lab=#net11}
N 1310 250 1340 250 { lab=OUT,buf_out[6:0]}
N 1340 250 1340 270 { lab=OUT,buf_out[6:0]}
N 1220 230 1220 320 { lab=out2[63:56]}
N 1390 230 1390 290 { lab=out2[0],out2[63:57]}
...
C {singlestage_nbr.sym} 1370 190 0 0 {name=x5[63:56]}
...
C {singlestage_nbr.sym} 950 190 0 0 {name=x6[55:48]}
...
C {singlestage_nbr.sym} 530 190 0 0 {name=x7[47:40]}
...
C {singlestage_nbr.sym} 120 190 0 0 {name=x8[39:32]}
...
C {devices/lab_pin.sym} 1220 20 0 0 {name=l47 sig_type=std_logic lab=out2[7:0]}
C {devices/lab_pin.sym} 1390 40 0 0 {name=l48 sig_type=std_logic lab=out2[8:1]}
C {devices/lab_pin.sym} 800 20 0 0 {name=l49 sig_type=std_logic lab=out2[15:8]}
C {devices/lab_pin.sym} 970 20 0 0 {name=l50 sig_type=std_logic lab=out2[16:9]}
C {devices/lab_pin.sym} 380 30 0 0 {name=l51 sig_type=std_logic lab=out2[23:16]}
C {devices/lab_pin.sym} 550 20 0 0 {name=l52 sig_type=std_logic lab=out2[24:17]}
C {devices/lab_pin.sym} -30 20 0 0 {name=l53 sig_type=std_logic lab=out2[31:24]}
C {devices/lab_pin.sym} 140 20 0 0 {name=l54 sig_type=std_logic lab=out2[32:25]}
C {devices/lab_pin.sym} -30 290 0 0 {name=l55 sig_type=std_logic lab=out2[39:32]}
C {devices/lab_pin.sym} 140 310 0 0 {name=l56 sig_type=std_logic lab=out2[40:33]}
C {devices/lab_pin.sym} 380 300 0 0 {name=l57 sig_type=std_logic lab=out2[47:40]}
C {devices/lab_pin.sym} 550 290 0 0 {name=l58 sig_type=std_logic lab=out2[48:41]}
C {devices/lab_pin.sym} 800 300 0 0 {name=l59 sig_type=std_logic lab=out2[55:48]}
C {devices/lab_pin.sym} 970 320 0 0 {name=l60 sig_type=std_logic lab=out2[56:49]}
C {devices/lab_pin.sym} 1220 300 0 0 {name=l61 sig_type=std_logic lab=out2[63:56]}
C {devices/lab_pin.sym} 1390 280 0 0 {name=l62 sig_type=std_logic lab=out2[0],out2[63:57]}
