...
S {}
E {}
N 1140 -1310 1140 -1280 { lab=GND}
N 1140 -1390 1140 -1370 { lab=#net1}
N 1330 -1390 1410 -1390 { lab=in}
N 1980 -1440 2110 -1440 { lab=VDD}
N 2110 -1440 2110 -1410 { lab=VDD}
N 2110 -1350 2110 -1320 { lab=GND}
N 1430 -1430 1450 -1430 { lab=in}
N 1430 -1430 1430 -1340 { lab=in}
N 1430 -1340 1450 -1340 { lab=in}
N 1410 -1390 1430 -1390 { lab=in}
...
N 1140 -1390 1260 -1390 { lab=#net1}
N 1380 -1330 1380 -1290 { lab=GND}
N 1380 -1290 1500 -1290 { lab=GND}
N 1640 -1330 1640 -1290 { lab=GND}
N 1770 -1330 1770 -1290 { lab=GND}
C {devices/vsource.sym} 2110 -1380 0 0 {name=V1 value=1.8}
C {devices/gnd.sym} 2110 -1320 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} 1140 -1340 0 0 {name=V2 value=PULSE"(1.8 0 1ns 10ps 10ps 1ns 2ns)"}
C {devices/gnd.sym} 1140 -1280 0 0 {name=l3 lab=GND}
C {devices/code.sym} 1020 -1770 0 0 {name=TT_MODELS
only_toplevel=true
...
dowhile run <= mc_runs
tran 0.1p 2n
wrdata ~/372puf/ee372/inverter_data_collect/inverter\{$&run\}_out.txt v(out)
wrdata ~/372puf/ee372/inverter_data_collect/inverter\{$&run\}_in.txt v(in)
reset
let run = run + 1
end
...
C {sky130_stdcells/inv_1.sym} 1290 -1390 0 0 {name=x3 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/capa.sym} 1380 -1360 0 0 {name=C2
m=1
value=2f
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} 1640 -1360 0 0 {name=C3
m=1
value=2f
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} 1770 -1360 0 0 {name=C4
m=1
value=2f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 1360 -1390 0 0 {name=l7 sig_type=std_logic lab=in}
